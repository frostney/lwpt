...
DIAGNOSTIC_RUN_RE = re.compile(
    ...
    r"(?:(?:aarch64-darwin|x86_64-darwin)/scheduling|"
    r"x86_64-darwin/default|"
...
class Controller:
    ...
    def diagnostic(
        ...
        valid_slice = (
            target in {"aarch64-darwin", "x86_64-darwin"}
            and selector == "scheduling"
        ) or (
            target == "x86_64-darwin" and selector == "default"
        ) or (
