...
| `[format]` | `include = [...]` adds format-scope globs; `exclude = [...]` subtracts them. Root `.lwpt/**` toolkit state is excluded by default unless an explicit include matches it (ADR-0026) |
