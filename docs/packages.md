...
| `source/shared/TransportSecurity.pas` | `packages/httpclient/source/TransportSecurity.pas` | LWPT ahead | Server accept, bounded flow control, strict identity validation, and atomic snapshot reload live only in the LWPT-canonical package pending GocciaScript Path A adoption. |
