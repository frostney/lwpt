...
| **`tests/integration/BuildClean.Test.pas`** | 4 tests in 1 suite (Unix); 3 tests in 1 suite (Windows) | Covers non-destructive clean behavior, preservation of unrelated files, a missing build directory, and Unix symlink boundaries. |
...
| Integration | 23 | 272 Darwin / 271 Linux / 266 Windows |
| E2E | 7 | 34 Darwin, Windows / 37 Linux |
| **Total** | **62** | **859 Darwin / 861 Linux / 840 Windows** |
