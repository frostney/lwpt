...
| **`source/LWPT.Registry.Store.Test.pas`** | 23 tests in 1 suite | Covers stable origin identity, signed state and restart recovery, atomic publication and checkpoint renewal, concurrent readers, safe initialization and lease recovery, portable index keys, path and URL validation, content-hash verification, cache policy, canonical error responses, and stable tamper diagnostics. |
...
| ---: | --- |
| **72** | **976 Darwin / 978 Linux / 954 Windows** |
