...
| **`tests/e2e/RegistryMirror.E2E.Test.pas`** | 4 tests in 1 suite | Exercises real origin and mirror CLI processes with binary archives: bootstrap, incremental and idempotent verified-object reuse, exact accepted-pointer retention after missing or tampered content, retry, origin outage, mirror restart, freshness and failure diagnostics, and mandatory immutable root pins. |
...
| ---: | --- |
| **74** | **1073 Darwin / 1075 Linux / 1052 Windows** |
