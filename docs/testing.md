...
| **`source/LWPT.Registry.Store.Test.pas`** | 21 tests in 1 suite | Covers stable origin identity, signed state and restart recovery, atomic publication and checkpoint renewal, concurrent readers, safe initialization and lease recovery, path and URL validation, content-hash verification, cache policy, and stable tamper diagnostics. |
...
| ---: | --- |
| **72** | **972 Darwin / 974 Linux / 950 Windows** |
