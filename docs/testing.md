...
matching. `lwpt test --inventory [selector...]` compiles the selected programs,
...
| **`source/LWPT.TestInventory.Test.pas`** | 4 tests in 1 suite | Pins platform-rule specificity, ambiguity failures, canonical documentation convergence, and the actionable stale-documentation path. |
...
| --- | ---: | --- |
| Unit | 31 | 538 Unix / 536 Windows |
| Integration | 23 | 265 Darwin / 264 Linux / 260 Windows |
| E2E | 7 | 32 Darwin, Windows / 35 Linux |
| **Total** | **61** | **835 Darwin / 837 Linux / 828 Windows** |
