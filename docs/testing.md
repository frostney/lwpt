...
| **`source/LWPT.BuildCache.Test.pas`** | 10 tests in 1 suite | Covers verified result manifests and artifact materialization, Unix mode restoration, deterministic misses, invalid fingerprints, reason-preserving corrupt-artifact rejection, budget refusal without partial logical results, deterministic distinct-result artifact eviction, both sides of concurrent store/materialize invalidation, and concurrent cross-process publication without partial or mismatched results. |
...
| ---: | --- |
| **69** | **950 Darwin / 952 Linux / 928 Windows** |
