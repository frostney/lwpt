...
| **`source/LWPT.Observability.Test.pas`** | 5 tests in 1 suite | Pins typed job, heartbeat, diagnostic, byte-safe child-output, command-terminal, truncation, and capture-degradation payloads, including source/correlation tags and ordinary/protected/terminal retention classes. |
...
| --- | --- | --- |
| Unit (`source/*.Test.pas` + package self-tests) | 28 | 483 |
| Integration (`tests/integration/*.Test.pas`) | 22 | 220 |
