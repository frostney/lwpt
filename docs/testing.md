...
| **`tests/e2e/RegistryMirror.E2E.Test.pas`** | 6 tests in 1 suite | Exercises real origin and mirror CLI processes with binary archives: bootstrap, incremental and idempotent verified-object reuse, accepted-pointer retention and candidate metadata rejection after failure, readable activated snapshot ancestry, retry, origin outage, mirror restart, freshness and failure diagnostics, immutable root pins and exact key documents, and bounded forced child shutdown. |
...
| ---: | --- |
| **74** | **1076 Darwin / 1078 Linux / 1055 Windows** |
