...
default, E2E, and TLS slices plus a bounded Intel-Darwin scheduling probe that
captures a native process sample on timeout. `full-ci` is a terminal promotion:
